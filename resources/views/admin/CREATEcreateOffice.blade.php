                        ...
                        <form action="{{route('createOffice')}}" method="POST">
                            ...
                            <div class="row">
                                <div class="col-lg-6 mt-3 mt-lg-0">
                                    ...
                                    <!-- <input  value="" type="hidden" name="parentOfficeId" id="officeLevel"> -->
                                ...
                                <div class="col-lg-4">
                                 ...
                                 -->
                                        ...
                                        <input name="lga" type="text" class="form-control" data-provide="typeahead" id="remote" placeholder="10 John str, Ipaja" value="{{old('location ')}}">
                                        <!-- </select> -->
