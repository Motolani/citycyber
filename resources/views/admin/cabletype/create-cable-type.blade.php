    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                ...
                <h4 class="page-title ">Create Cable Type</h4>
            </div>
        </div>
    </div>
    <!-- end page title -->
        ...
        <div class="col-8 offset-2" id = "h_div" style = "align-content:center, float:right">
            <div class="card">
                <div class="card-body" >
                    <h4 class="header-title" style = "">Create Type
                    </h4>
                    ...
                    <p class="text-muted font-14">
                        Here you can create cable type  
                    </p>

                    <div class="tab-content">
                        <div class="tab-pane show active" id="typeahead-preview">
                            <form method = "POST" action = "{{url('store-cable-type')}}">
                                @csrf
                                {{-- @method('PUT') --}}
                                <div class="row ">
                                    <div class="col-md-8  mb-3">
                                    <label for="cable type">Cable Type Name</label>
                                        <input type="text"  name="cable_type_name" class="form-control" placeholder="please enter the cable type">
                                    </div>                       
                                    </div> 
                                    ...
                                    <div class="col-md-12 ">
                                        ...
                                        <button type="submit" class="btn btn-primary">Create Cable type</button>
                                    </div>
                                  </div>
                            </form>
                        </div> <!-- end preview-->
