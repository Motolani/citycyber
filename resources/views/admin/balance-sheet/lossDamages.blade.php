                ...
                <div class="tab-content">
                    <div class="tab-pane show active" id="buttons-table-preview">
                        <table id="datatable-buttons" class="table data-table table-striped dt-responsive nowrap w-100">
                            ...
                            <tbody>
                            @foreach($lossDamages as $lossDamage)
                                <tr>
                                    <td>{{$lossDamage->created_at}}</td>
                                    <td>{{$lossDamage->staff_id}}</td>
                                    <td>{{$lossDamage->amount}}</td>
                                    <td>{{$lossDamage->status}}</td>
                                    <td>{{$lossDamage->property_lost}}</td>
                                    <td>{{$lossDamage->issuer_id}}</td>
                                    <td>{{$lossDamage->comment}}</td>
                                </tr>
                                @endforeach
