                        ...
                        <table id="datatable-buttons" class="table data-table table-striped dt-responsive nowrap w-100">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <form method="get" action="{{route('view.balanceSheet.detail.advance')}}">
                                            @csrf
                                ...
                                <tr>
				                    ...
				                    <td>-</td>                    
                                    <td>
                                        <form method="get" action="{{route('view.balanceSheet.detail.deduction')}}">
                                            @csrf
                                            <button class="btn btn-primary btn-sm"><span class="uil-eye"></span></button>
                                        </form>
                                    </td>
                                ...
                                <tr>
				                    ...
				                    <td>-</td>                    
                                    <td>
                                        <form method="get" action="{{route('view.balanceSheet.detail.loan')}}">
                                            @csrf
                                            <button class="btn btn-primary btn-sm"><span class="uil-eye"></span></button>
                                        </form>
                                    </td>
                                ...
                                <tr>
				                    ...
				                    <td>{{$totalBonuses}}</td>                    
                                    <td>
                                        <form method="get" action="{{route('view.balanceSheet.detail.bonus')}}">
                                            @csrf
                                            <button class="btn btn-primary btn-sm"><span class="uil-eye"></span></button>
                                        </form>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form method="get" action="{{ route('view.balanceSheet.detail.cashAdvance')}}">
                                            @csrf
                                            <button class="btn btn-primary btn-sm"><span class="uil-eye"></span></button>
                                        </form>
                                    </td>
                                ...
                                <tr>
				                    ...
				                    <td>-</td>                    
                                    <td>
                                        <form method="get" action="{{ route('view.balanceSheet.detail.lateness')}}">
                                            @csrf
                                            <button class="btn btn-primary btn-sm"><span class="uil-eye"></span></button>
                                        </form>
                                    </td>
                                ...
                                <tr>
				                    ...
				                    <td>-</td>                    
                                    <td>
                                        <form method="get" action="{{route('view.balanceSheet.detail.lossDamages')}}">
                                            @csrf
                                            <button class="btn btn-primary btn-sm"><span class="uil-eye"></span></button>
                                        </form>
                                    </td>
                                ...
                                <tr>
				                    ...
				                    <td>-</td>                    
                                    <td>
                                        <form method="get" action="{{route('view.balanceSheet.detail.offences')}}">
                                            @csrf
                                            <button class="btn btn-primary btn-sm"><span class="uil-eye"></span></button>
                                        </form>
                                    </td>
                                ...
                                <tr>
				                    ...
				                    <td>-</td>                    
                                    <td>
                                        <form method="get" action="{{route('view.balanceSheet.detail.officeStocks')}}">
                                            @csrf
                                            <button class="btn btn-primary btn-sm"><span class="uil-eye"></span></button>
                                        </form>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form method="get" action="{{route('view.balanceSheet.detail.pettyCash')}}">
                                            @csrf
                                            <button class="btn btn-primary btn-sm"><span class="uil-eye"></span></button>
                                        </form>
                                    </td>
                                ...
                                <tr>
				                    ...
				                    <td>-</td>                    
                                    <td>
                                        <form method="get" action="{{route('view.balanceSheet.detail.poolWallet')}}">
                                            @csrf
                                            <button class="btn btn-primary btn-sm"><span class="uil-eye"></span></button>
                                        </form>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form method="get" action="{{route('view.balanceSheet.detail.cashierWallet')}}">
                                            @csrf
                                            <button class="btn btn-primary btn-sm"><span class="uil-eye"></span></button>
                                        </form>
                                    </td>
                                ...
                                <tr>
				                    ...
				                    <td>-</td>                    
                                    <td>
                                        <form method="get" action="{{route('view.balanceSheet.detail.cashReserveWallet')}}">
                                            @csrf
                                            <button class="btn btn-primary btn-sm"><span class="uil-eye"></span></button>
                                        </form>
                                    </td>
                                ...
                                <tr>
				                    ...
				                    <td>-</td>                    
                                    <td>
                                        <form method="get" action="{{route('view.balanceSheet.detail.shopWallet')}}">
                                            @csrf
                                            <button class="btn btn-primary btn-sm"><span class="uil-eye"></span></button>
                                        </form>
                                    </td>
                                ...
                                <tr>
				                    ...
				                    <td>{{$totalWins}}</td>                    
                                    <td>
                                        <form method="get" action="{{ route('view.balanceSheet.detail.win')}}">
                                            @csrf
                                            <button class="btn btn-primary btn-sm"><span class="uil-eye"></span></button>
                                        </form>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form method="get" action="{{route('view.balanceSheet.detail.inventoryStore')}}">
                                            @csrf
                                            <button class="btn btn-primary btn-sm"><span class="uil-eye"></span></button>
                                        </form>
                                    </td>
