                        ...
                        <table id="datatable-buttons" class="table data-table table-striped dt-responsive nowrap w-100">
                            <thead>
                                <tr>
                                    ...
                                    <th>Category Id</th>
                                    <th>Cost</th>
                                    <th>Depeciation Rate</th>
                                    <th>Depeciation Period</th>
                                    <th>Status</th>
                                </tr>
                            </thead>
                            ...
                            <tbody>
                                @foreach($inventoryStore as $inventory)
                                    <tr>
                                        <td>{{$inventory->created_at}}</td>
                                        <td>{{$inventory->office_id}}</td>
                                        <td>{{$inventory->staff_id}}</td>
                                        <td>{{$inventory->name}}</td>
                                        <td>{{$inventory->category_id}}</td>
                                        <td>{{$inventory->price}}</td>
                                        <td>{{$inventory->description_rate}}</td>
                                        <td>{{$inventory->description_period}}</td>
