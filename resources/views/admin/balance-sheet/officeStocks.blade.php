                    ...
                    <div class="tab-pane show active" id="buttons-table-preview">
                        <table id="datatable-buttons" class="table data-table table-striped dt-responsive nowrap w-100">
                            ...
                            @foreach($officeStocks as $officeStock)
                                <tr>
                                    <td>{{$officeStock->created_at}}</td>
                                    <td>{{$officeStock->inventory_id}}</td>
                                    <td>{{$officeStock->category_id}}</td>
                                    <td>{{$officeStock->category}}</td>receiver_id
                                    <td>{{$officeStock->sender_id}}</td>
                                    <td>{{$officeStock->sender_id}}</td>
                                    <td>{{$officeStock->status}}</td>
                                    <td>{{$officeStock->receiver_id}}</td>
                                    <td>{{$officeStock->payment_status}}</td>
                                </tr>
                                @endforeach
