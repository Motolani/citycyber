            ...
            <div class="page-title-box">
                ...
                <a href="{{url('/create-asset')}}" class="btn btn-primary mb-2" >Go Back</a>
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item active" style = "display:none" id = "headerShow">Create Asset</li>
                    </ol>
                </div>
    ...
    <div class="col-9">
        <div class="card">
            <div class="card-body">
                ...
                <h4 class="header-title" style = "">Create Asset</h4>
                ...
                <div class="tab-content">
                    <div class="tab-pane show active" id="input-types-preview">
                        <div class="row justify-content-center">
                            <div class="col-lg-9">
                                <form action = "{{route('updateAsset',$asset->id)}}" method = "POST"> 
                                    ...
                                    <div class="row">
                                         <div class="col-lg-9">
                                            <div class="mb-3">
                                                <label class="form-label">Input Asset Name</label>
                                                <input name="type" type="text" value="{{$asset->type}}" class="form-control">
                                            </div>
                                        </div>  
                                    </div>
