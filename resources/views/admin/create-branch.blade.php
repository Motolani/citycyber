            ...
            <div class="page-title-box">
                ...
                <a href="{{url('/create-branch')}}" class="btn btn-primary mb-2" >Go Back</a> 
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item active" style = "display:none" id = "headerShow">Branch Classification</li>
                    </ol>
                </div>
                <h4 class="page-title">Branch Classification</h4>
            </div>
        </div>
    </div>
    <!-- end page title -->
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-9">
                                <form action = "{{route('storeBranch')}}" method = "POST"> 
                                    ...
                                    <h3>Create Branch Classification</h3>
                                    <br>
                                    <br>
                                    <div class="row">
                                         <div class="col-lg-9">
                                            <div class="mb-3">
                                                <label class="form-label">Input Branch Name</label>
                                                <input name="type" type="text" value="{{old('type')}}" required  class="form-control">
                                            </div>
                                        </div>  
                                    </div>

                                <div class="col-auto">
                                        <button type="submit" name = "submit"   id="submit" class="btn btn-primary mb-9">Submit</button>
                                </div> 
