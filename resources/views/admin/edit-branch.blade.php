            ...
            <div class="page-title-box">
                ...
                <a href="{{url('/create-branch')}}" class="btn btn-primary mb-2" >Go Back</a>
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item active" style = "display:none" id = "headerShow">Create Branch Classification</li>
                    </ol>
                </div>
                <h4 class="page-title">Create Branch Classification</h4>
            </div>
        </div>
    </div>
    <!-- end page title -->
    ...
    <div class="col-9">
        <div class="card">
            <div class="card-body">
                ...
                <h4 class="header-title" style = "">Create Branch Classification</h4>
                                    ...
                                    <div class="row">
                                         <div class="col-lg-9">
                                            <div class="mb-3">
                                                ...
                                                <input name="type" type="text" value="{{$branch->type}}" class="form-control">
                                            </div>
                                        </div>  
                                    </div>
