        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="tab-content">
                        ...
                        <form action="{{route('createOffice')}}" method="POST" id="formValidation">
                            ...
                            <div class="row">
                                <div class="col-lg-6 mt-3 mt-lg-0">
                                    ...
                                    <input type="text" class="form-control" name="officeCode" data-provide="typeahead" id="officeId" placeholder="" required autocomplete="off">
				    ...
				    <select id="types" class="form-control select2" data-toggle="select2" required>
                                ...
                                <div class="col-lg-6 mt-3">
                                    ...
                                    <input type="text" class="form-control" name="type" data-provide="typeahead" value="" readonly id="officeType" placeholder="" required autocomplete="off">
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-3 mt-3">
                                        ...
                                        <input type="text" name="name" class="form-control" data-provide="typeahead" id="name" placeholder="name" value="{{old('name')}}" required autocomplete="off">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="mb-3 ">
                                                ...
                                                <input type="text" class="form-control" name="region_acronym" id="region_acronym" value="{{old('region_acronym')}}" id="" placeholder="enter region acronym" required autocomplete="off">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" name="area_acronym" id="area_acronym" value="{{old('area_acronym')}}" id="" placeholder="enter area acronym" required autocomplete="off">
                                ...
                                <div class="col-lg-6 mt-3 mt-lg-0">
                                    <div class="mb-3">
                                        ...
                                        <input id="emailAddress" name="emailAddress" class="form-control" type="text" placeholder="email" value="{{old('emailAddress')}}" required autocomplete="off">
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control" data-provide="typeahead" id="phone" name="phone" placeholder="phone" value="{{old('phone')}}" required autocomplete="off" minlength="11" maxlength="11">
                                ...
                                <div class="col-lg-12">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control" data-provide="typeahead" id="phone_number" name="phone_number" placeholder="phone" value="{{old('phone')}}" required autocomplete="off" minlength="11" maxlength="11">
                                ...
                                <div class="col-lg-12 mt-3 mt-lg-0">
                                    <div class="mb-3">
                                        ...
                                        <input name="location" type="text" class="form-control" data-provide="typeahead" id="location" placeholder="10 John str, Ipaja" value="{{old('location ')}}" required autocomplete="off">
                                ...
                                <div class="col-lg-4">
                                    ...
                                    <select name="country" class="form-control select2 country" data-toggle="select2" required>
                                ...
                                <div class="col-lg-4">
                                 ...
                                 -->
                                        ...
                                        <input name="lga" type="text" class="form-control" data-provide="typeahead" id="lga" placeholder="10 John str, Ipaja" value="{{old('location ')}}" required autocomplete="off">
                                ...
                                <div class="branch-office " style="display: none;">
                                    <div class="row g-3">
                                        <div class="col-md-6 py-2">
                                            ...
                                            <input type="text" name="bet_code" id="bet_code" class="form-control @error('bet_code') is-invalid @enderror" placeholder="bet9ja code" required autocomplete="off">
                                        ...
                                        <div class="col-md-6 py-2">
                                            ...
                                            <input type="text" name="bet_id" id="bet_id" class="form-control @error('bet_id') is-invalid @enderror" placeholder="bet9ja id" required autocomplete="off">
                                    ...
                                    <div class="row g-3">
                                        <div class="col-md-6 py-2">
                                            ...
                                            <input type="text" name="land_name" id="land_name" class="form-control @error('land_name') is-invalid @enderror" placeholder="landlord name " required autocomplete="off">
                                        ...
                                        <div class="col-md-6 py-2">
                                            ...
                                            <input type="number" name="land_phone" id="land_phone" class="form-control @error('land_phone') is-invalid @enderror" placeholder="landlord phone" required autocomplete="off">
                                    ...
                                    <div class="row g-3">
                                        <div class="col-md-6 py-2">
                                            ...
                                            <input type="email" name="land_email" id="land_email" class="form-control @error('land_email') is-invalid @enderror" placeholder="landlord email" required autocomplete="off">
                                        ...
                                        <div class="col-md-6 py-2">
                                            ...
                                            <input type="text" name="care_name" id="care_name" class="form-control @error('care_name') is-invalid @enderror" placeholder="caretaker name" required autocomplete="off">
                                    ...
                                    <div class="row g-3">
                                        <div class="col-md-6 py-2">
                                            ...
                                            <input type="number" name="care_phone" id="care_phone" class="form-control @error('care_phone') is-invalid @enderror" placeholder="caretaker phone">
                                        ...
                                        <div class="col-md-6 py-2">
                                            ...
                                            <input type="email" name="care_email" id="care_email" class="form-control @error('care_email') is-invalid @enderror" placeholder="caretaker email" required autocomplete="off">
                                ...
                                <div style="justify-content:flex-end" class="col-lg-12 pull-right mt-3">
                                    ...
                                    <input type="submit" class="btn btn-primary w-100" value="submit" id="submitBtn" />
                                </div>
                            </div>
                            <!-- end row -->
                        </form>
