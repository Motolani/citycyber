    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                ...
                <h4 class="page-title ">Create Cable Subscription</h4>
            </div>
        </div>
    </div>
    <!-- end page title -->
        ...
        <div class="col-12" id = "h_div" style = "align-content:right, float:right">
            <div class="card">
                <div class="card-body" >
                    <h4 class="header-title" style = "">Create subscription
                    </h4>
                    ...
                    <p class="text-muted font-14">
                        Here you can create cable subscription with branch office, cable tv and cable plan e.t.c
                    </p>

                    <div class="tab-content">
                        <div class="tab-pane show active" id="typeahead-preview">
                            <form method = "POST" action = "{{url('store-cable-subscription')}}">
                                @csrf
                                ...
                                <div class="row ">
                                    ...
                                    <select  name="smart_card"  class="form-select form-control" >
                                        ...
                                        {{-- <input type="number" min="0" name="smart_card" class="form-control" placeholder="enter smart card number"> --}}
                                    </div>
                                    ...
                                    <div class="col-md-4 mb-3">
                                        <label for="card number">Amount</label>
                                         <input type="number" min="0" name="amount"  class="form-control" placeholder="enter amount" autocomplete="off">
                                      </div>
                                        <div class="col-md-4 mb-3  ">
                                            <label for="card number">Subscription Date</label>
                                            <input type="text" id="subdate" name="subscription_date" class="form-control" placeholder="Click to enter subscription date" autocomplete="0ff">     
                                        ...
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <input type="text"   name="expiring_date" id="expdate" class="form-control" placeholder="Click to enter expiring date" autocomplete="0ff">     
                                        ...
                                        <div class="col-md-12 mb-3">
                                            ...
                                            <input type="text"  name="remarks"  class="form-control" placeholder="Click to enter remarks" autocomplete="0ff">     
