        ...
        <table class="table table-hover work_experience">
            ...
            <tbody>
                <tr>
                    ...
                    <td>
                        <span class="d-block p-2 bg-light text-primary" id="institution_name"></span>
                    </td>

                    <td>
                        <div class="mb-3 position-relative" id="work_start_year">
                        <span class="d-block p-2 bg-light text-primary" id="work_start_year"></span>
                        </div>
                    </td>

                    <td>
                        <div class="mb-3 position-relative" id="work_end_year">
                        <span class="d-block p-2 bg-light text-primary" id="work_end_year"></span>
                        </div>
                    </td>

                    <td>
                        <span class="d-block p-2 bg-light text-primary" id="position_held"></span>
                    </td>

                    <td>
                    <span class="d-block p-2 bg-light text-primary" id="job_function"></span>
                    </td>
