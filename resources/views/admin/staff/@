                                ...
                                <table class="table table-hover work_experience">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <textarea autocomplete="off" value="{{ Session::has('workEducation') ? Session::get('workEducation')['job_functions'][$i] : '' }}" class="form-control underline"
                                                        name="job_functions[]" id=""></textarea>
                                                </td>
                                    ...
                                    @else
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input autocomplete="off" class="form-control underline" id="establishment_name" type="text"name="establishment_name[]">
                                            </td>

                                            <td>
                                                <input placeholder="YYYY only e.g 2004" autocomplete="off" value=""
                                                    class="form-control underline" id="work_start_year" type="text"
                                                    name="work_start_year[]">
                                            </td>
                                                ...
                                                <td>
                                                    ...
                                                    <select class="form-control" name="education_type_id[]"
                                                        ...
                                                        <?php
                                                            ...
                                                            $educationClass = null;
                                                            if(Session::has('workEducation')){
                                                                $workEducation = Session::get('workEducation');
                                                                $ex= explode("|",$workEducation['education_type_id'][$i]);
                                                                $expQual = explode("|",$workEducation['education_qual_id'][$i]);
                                                                $expClass = explode("|",$workEducation['education_class_id'][$i]);
                                                                $educationType =$ex[1];  
                                                                $qualification =$expQual[1];
                                                                $educationClass =$expQual[1];
                                                            }
                                                        ?>
                                                        <option
                                                        value="{{ Session::has('workEducation') ? Session::get('workEducation')['education_type_id'][$i] : '' }}" 
							>{{ isset($educationType) ?$educationType: '' }}</option>
                                                        @if(isset($education_type_collection))
                                                        @if(!$education_type_collection->isEmpty())
                                                            @foreach($education_type_collection as $val)
                                                            <option value="{{$val->id}}|{{$val->type}}">{{$val->type}}</option>
                                                            @endforeach
                                                        @endif
                                                        @endif
                                                    </select>
                                                ...
                                                <td>
                                                    <select class="form-control" name="education_qual_id[]"
                                                        ...
                                                        >{{ isset($qualification) ?$qualification: '' }}</option>
                                                ...
                                                <td>
                                                    <select class="form-control" name="education_class_id[]"
                                                        ...
                                                        >{{ isset($educationClass) ?$educationClass: '' }} }}</option>
                                    ...
                                    @else
                                        <tr>
                                            ...
                                            <td>
                                                <input autocomplete="off" placeholder="Ignore if not applicable"
                                                    value="{!! old('course_name') !!}" class="form-control underline"
                                                    id="course_name" type="text" name="course_name[]">
                                            </td>
