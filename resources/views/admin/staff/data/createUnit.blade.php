    ...
    <div class="col-12" id="h_div" style="align-content:right, float:right">
		...
		@endif
                ...
                <ul class="nav nav-tabs nav-bordered mb-3">
                    <li class="nav-item">
                        <a href="Unit" data-bs-toggle="tab" aria-expanded="false" class="nav-link active">
                            Create Unit
                        </a>
                    </li>
                </ul> <!-- end nav-->
                        ...
                        <form method="POST" action="{{route('createUnit')}}">
                            ...
                            <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            <label class="form-label">Enter Unit Name</label>
                                ...
                                <div class="row" style="margin-top:10px">
                                    ...
                                    <div style="" class="col-lg-6 ">
                                        <button name="submit" value="createUnit" class="btn btn-primary"
                                            style="float: right;" id="submit">Create Unit</button>
                                    </div>
                                </div>
                            </div>
                            <!-- end row -->
