		...
		@if (isset($message))
            	...
            	@endif
                    ...
                    <button name = "submit" value = "edit" class="btn btn-primary btn-md" data-bs-toggle="modal"
                                                data-bs-target="#new-modal" ><span class="uil-plus"></span> Create New Staff Status</button>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control" type="text" id="name" name="title"
                                    value="" required="" placeholder="New Staff Status">
                            </div>
    ...
    <div class="tab-pane show active" id="modal-position-preview">
        ...
        <!-- Right modal content -->
						...
						<button value = "edit" class="btn bg-info btn-sm" data-bs-toggle="modal"
                                		data-bs-target="#edit-modal{{$stat->id}}"><span style="color: #fff" class="uil-pen"></span></button>
						<a onclick="return confirm('Are you sure you want to delete {{$stat->title}}?, this action is not be reversable!.')" class="btn btn-danger btn-sm"
						href="{{url('/deletestatus/' . $stat->id)}}"><span class="uil-trash"></span></a>
                                            </td>
