        ...
        <div class="page-title-box">
            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    ...
                    <li class="breadcrumb-item active">Create Leave Category</li>
                </ol>
            </div>
            <h4 class="page-title">Leave Category</h4>
        </div>
    </div>
    </div>     
    <!-- end page title --> 
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                @endif
                <h4 class="header-title">Create Leave Category</h4>
                ...
                <div class="tab-content">
                    <div class="tab-pane show active" id="input-types-preview">
                        <div class="row">
                            <div class="col-lg-6">
                                <form action = "{{url('createLeaveCategory')}}" method="POST"> 
                                    @csrf

                                    <div class="mb-3">
                                        <label for="example-email" class="form-label">Staff Leave Category</label>
                                        <input type="text" id="type" name="type" class="form-control" placeholder="Enter Level">
                                    </div>
