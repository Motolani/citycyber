            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active" style = "display:none" id = "headerShow">Delete/Edit Leave</li>
                    </ol>
                </div>
                <h4 class="page-title">Delete/Edit Leave</h4>
            </div>
        </div>
    </div>
    <!-- end page title -->
        ...
        <div class="col-12">
            <div class="card">
            	...
            	@endif
                    ...
                    <a name="submit" value="edit" class="btn btn-primary" href="{{url('createLeaveType')}}"><span
                                ...
                                @if(isset($offtypes))
                                    @foreach($offtypes as $type)
                                        <tr>
                                            ...
                                            <td>
                                                <button  data-bs-toggle="modal" data-bs-target="#top-modal" onclick="toggleModal('{{$type->type}}','{{$type->days}}','{{$type->id}}')"  class="btn btn-primary btn-sm phils" ><span class="uil-eye"></span></button>
                                            
                                            </td>
                                            <td>
                                                <form method="post" action="{{url('updateDeleteLeaveType')}}">
                                                    @csrf
                        ...
                        <form class="ps-3 pe-3" action="{{url('updateDeleteLeaveType')}}" method="post">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" type="text"  id="typee" name = "type" value = ""  required="" placeholder="type">
                                </div>
