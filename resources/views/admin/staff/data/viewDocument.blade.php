                            ...
                            <table id="datatable-buttons" class="table data-table table-striped dt-responsive nowrap w-100">
                                ...
                                @if(isset($document_table))
                                    @foreach($document_table as $type)
                                        <tr>
                                            <td>
                                                <button  data-bs-toggle="modal" data-bs-target="#top-modal" onclick="toggleModal('{{$type->name}}','{{$type->id}}')"  class="btn btn-primary btn-sm phils" >
                ...
                <div class="modal-dialog modal-top">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title" id="topModalLabel">Edit Document</h4>
