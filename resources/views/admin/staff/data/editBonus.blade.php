            ...
            <div class="card-body">
                ...
                <div class="card  px-3 w-100 m-auto mb-5">
                    <div class="row justify-content-center">
                        <div class="col-md-12">
                            <h4 class="page-title">ISSUE BONUS</h4>
                            <hr>
                            <form action="{{url('createbonus')}}" method="POST">
                                @csrf
                                <div class="mb-3">
                                    <label for="example-email" class="form-label">Bonus</label>
                                    <input type="text" id="example-email" name="bonus" class="form-control" placeholder="Enter bonus" required>
                                </div>
                                ...
                                <button type="submit" name="submit" class="btn btn-primary mt-2 mb-2 ">CREATE BONUS
                                </button>
                            </form>
                        </div>
                    </div>
