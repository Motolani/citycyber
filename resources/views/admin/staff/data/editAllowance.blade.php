            ...
            <div class="card-body">
				...
				<div class="form-group mt-2 mb-2">
					...
					<select id="offices" class="form-control select2">
						...
						<option value="{{$office->id}}" {{$allowance->id == $office->id ? "selected" : "" }}>{{$office->name}}</option>
						@endforeach
					</select>
				</div>
				<div class="form-group mt-2 mb-2">
					...
					<select id="staffid" class="form-control select2" name="staffid">
						<option>--All Staff--</option>
                                ...
                                <div class="form-group mt-2 mb-2">
                                    ...
                                    <input value="{{$allowance->amount}}" type="text" name="allowance" placeholder="Enter Allowance Name"
                                ...
                                <div class="form-group mt-2 mb-2">
                                    ...
                                    <select class="form-control select2" name="level" data-toggle="select2">
                                        ...
                                        <option value="{{$levels->title}}" {{$allowance->level == $levels->title ? "selected" : ""}}>{{$levels->title}}</option>                                        
                                        @endforeach
                                    </select>
                                </div>
                                <div class="form-group mt-2 mb-2">
                                    <label for="">Amount<span class="red" style="color:red" ;>&#x2a;</span></label>
                                    <input value="{{$allowance->amount}}" type="text" name="amount" placeholder="Enter Amount" class="form-control"
                                        required>
                                </div>
<?php //dd($allowance); ?>
                                <div class="form-group mt-2 mb-2">
                                    ...
                                    <select class="form-control select2 mt-2 mb-2" name="restriction" data-toggle="select2">
                                      {{--  <option>--No Time Restriction--</option>
                                        <optgroup>--}}
                                            	...
                                            	<option value="Daily" {{$allowance->restriction == "Daily" && "selected"}}>Daily</option>              	
					        <option value="Weekly" {{$allowance->restriction == "Weekly" && "selected"}}>Weekly</option>
                                                <option value="Bi-Weekly" {{$allowance->restriction == "Bi-Weekly" ? "selected" : ""}}>Bi-Weekly</option>
                                                <option value="Monthly" {{$allowance->restriction == "Monthly" ? "selected" : ""}}>Monthly</option>
                                                <option value="Quarterly" {{$allowance->restriction == "Quarterly" ? "selected" : ""}}>Quarterly</option>
                                                <option value="Yearly" {{$allowance->restriction == "Yearly" ? "selected" : ""}}>Yearly</option>
                                    ...
                                    <select class="form-control select2" name="durationbased" data-toggle="select2">
                                        <optgroup>
                                            <option value="NO" {{$allowance->durationbased == "NO" ? "selected" : "" }}>NO</option>
                                            <option value="YES" {{$allowance->durationbased == "YES" ? "selected" : "" }}>YES</option>
                                        </optgroup>
                                    </select>
                                </div>
