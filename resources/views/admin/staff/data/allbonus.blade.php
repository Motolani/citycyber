...
<div class="row">
    <div class="col-12">
        <div class="page-title-box">
            ...
            <h4 class="page-title">Staff Bonus Management</h4>
        </div>
    </div>
</div>
<!-- end page title -->
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <a name="submit" value="edit" class="btn btn-primary" href="{{url('newbonus')}}"><span
                        class="uil-plus"></span> Create New Bonus</a>

                <p style="margin-top: 10px" class="text-muted font-14">
                    Below are Bonuses made within City Cyber
                </p>
                                                    ...
                                                    <div class="modal-dialog modal-top">
                                                        <div class="modal-content">
                                                            ...
                                                            <form class="ps-3 pe-3"
                                                                action="{{url('updatebonus/' . $stat->id)}}"
                                                                method="POST">
                                                                @csrf
                                                                <div class="mb-3">
                                                                    <label for="example-email"
                                                                        class="form-label">Bonus</label>
                                                                ...
                                                                <div class="mb-3">
                                                                    ...
                                                                    <input type="text" id="example-amount"
                                                                ...
                                                                <button type="submit" name="submit"
                                                                    class="btn btn-primary mt-2 mb-2 ">UPDATE BONUS
                                                                </button>
                                                            </form>
                                                        </div><!-- /.modal-content -->
                                                    </div><!-- /.modal-dialog -->
