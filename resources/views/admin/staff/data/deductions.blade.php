    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <a name="submit" value="edit" class="btn btn-primary"  href="{{url('newdeduction')}}"><span class="uil-plus"></span> Create New Deduction</a>                
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <form class="ps-3 pe-3"
                                                                ...
                                                                <div class="mb-3">
                                                                    ...
                                                                    <input type="text" id="example-email" name="deduction" value={{$stat->deduction}} class="form-control" placeholder="Enter deduction" required>
                                                                </div>
