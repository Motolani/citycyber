    ...
    <div class="col-6">
        <div class="card">
            <div class="card-body">
                ...
                @endif
                <h4 class="header-title">Create Staff Offence</h4>
                ...
                <div class="tab-content">
                    <div class="tab-pane show active" id="input-types-preview">
                        <div class="row justify-content-center">
                            <div class="col-lg-6">
                                <form action = "{{route('createOffence')}}" method = "POST"> 
                                @csrf
                                    ...
                                    <div class="col-auto">
                                        <button type="submit" name = "submit" value = "createOffence" class="btn btn-primary mb-9">Create Offence</button>
                                    </div>
