                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    <div class="mb-0">
                                        ...
                                        <input class="form-control"
                                            value="{{ Session::has('personalInfo')?Session::get('personalInfo')['maritalStatus']:''}}"
                                        ...
                                        @for ($i = 0; $i < sizeof(Session::get('workEducation')['establishment_name']);
                                            ...
                                            <td>
                                                <textarea autocomplete="off"
                                                    ...
                                                    readonly>{{ Session::has('workEducation') ? Session::get('workEducation')['job_functions'][$i] : '' }}</textarea>
                                            </td>
