...
<div class="row">
    <div class="col-12">
        <div class="page-title-box">
            ...
            <h4 class="page-title">Staff Loan Management</h4>
        </div>
    </div>
</div>
<!-- end page title -->
                ...
                <div class="card  px-3 w-100 m-auto mb-5">
                    <div class="row justify-content-center">
                        <div class="col-md-12">
                            ...
                            <hr>
                            <form action="{{url('postCreateStaffLoan')}}" method="POST">
                                @csrf
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    <label for="example-email" class="form-label">Loan Types</label>
                                    
                                    <select id="deduction_id" class="form-control" name="loanTypeId" data-toggle="select" required>
                                        <option value="">Select Loan Type</option>
                                        @if(isset($branches))
                                            @foreach($loanTypes as $loanType)
                                                <option value="{{$loanType->id}}">{{$loanType->loanName}}</option>
                                            @endforeach
                                        @endif
                                    </select>
                                </div>
                                ...
                                <div class="mb-3">
                                    <label for="example-email" class="form-label">Repayment Types</label>
                                    
                                    <select id="deduction_id" class="form-control" name="repaymentId" data-toggle="select" required>
                                        <option value="">Select Repayment Type</option>
                                        @if(isset($branches))
                                            @foreach($repaymentTypes as $repaymentType)
                                                <option value="{{$repaymentType->id}}">{{$repaymentType->repaymentName}}</option>
                                            @endforeach
                                        @endif
                                    </select>
                                </div>
                                ...
                                <button type="submit" name="submit" class="btn btn-primary mt-2 mb-2 ">CREATE LOAN
                                </button>
                            </form>
                        </div>
                    </div>
