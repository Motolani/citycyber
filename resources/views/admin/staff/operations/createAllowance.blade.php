...
<div class="row">
    <div class="col-12">
        <div class="page-title-box">
            ...
            <h4 class="page-title">Create Staff Allowance</h4>
        </div>
    </div>
</div>
<!-- end page title -->
<div class="row justify-content-center">
    ...
    <div class="col-6">
        <div class="card">
            <div class="card-body">
                <h4 class="header-title">Create Staff Allowance</h4>
					...
					<div class="mb-3">
                                        ...
                                        <div class="mb-3">
                                            {{-- <input type="hidden" id="user_id" name="user_id" class="form-control" value="{{$user_id}}" >--}}
                                             ...
                                             <select id="offe" class="form-control" name="allowance_id" data-toggle="select" required>
