...
<div class="row">
    <div class="col-12">
        <div class="page-title-box">
            ...
            <h4 class="page-title">Request Staff Suspension</h4>
        </div>
    </div>
</div>
<!-- end page title -->
<div class="row justify-content-center">
	<div class="alert alert-success alert-dismissible fade show" role="alert">
        ...
        You must first Select the branch of the Staff before you can request suspension. 
    ...
    <div class="col-6">
        <div class="card">
            <div class="card-body">
                ...
                <h4 class="header-title">Create Staff Suspension Request</h4>
                    ...
                    <div class="tab-pane show active" id="input-types-preview">
                        <div class="row justify-content-center">
                            <div class="col-lg-6">
                                ...
                                @endif
                                <form action="{{url('suspension/create')}}" method="POST">
				                        @csrf
					                    <div class="mb-3">
                                        ...
                                        <button type="submit" name="submit" value = "createOffence"
                                            class="btn btn-primary mt-2 mb-2 ">Submit
                                        </button>
                                </form>
                            </div> <!-- end col -->
                        </div>
