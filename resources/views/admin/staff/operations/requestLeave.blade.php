                            ...
                            <form action="{{url('requestLeave')}}" method="GET">
                                ...
                                <div class="mb-3">
                                    {{-- <input type="hidden" id="user_id" name="user_id" class="form-control" value="{{isset($user_id)?$user_id:'1'}}" >--}}
                                     ...
                                     <select id="offe" class="form-control" name="leavetype_id" data-toggle="select" required>
                                 ...
                                 <div class="mb-3">
                                     ...
                                     <select id="offe" class="form-control" name="leavecategory_id" data-toggle="select" required>
                                ...
                                <div class="mb-3 position-relative" id="datepicker3">
                                    ...
                                    <input type="text" required placeholder="Multiple Date can be selected here" name = "dates" class="form-control" data-provide="datepicker" data-date-multidate="true" data-date-container="#datepicker3">
                                </div>
