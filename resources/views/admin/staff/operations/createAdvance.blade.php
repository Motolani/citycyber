    ...
    <div class="col-6">
        <div class="card">
            <div class="card-body">
                ...
                <h4 class="header-title">Raise Salary Advance</h4>
                ...
                <div class="tab-content">
					...
					<div class="mb-3">
                                        ...
                                        <div class="mb-3 position-relative" id="datepicker5">
                                            ...
                                            <input type="text" class="form-control" data-provide="datepicker" name = "endStart" data-date-format="MM yyyy" data-date-min-view-mode="1" data-date-container="#datepicker5" onchange="validateStartDate()">
                                        </div>

                                        <!-- Month View -->
                                        <div class="mb-3 position-relative" id="datepicker5">
                                            <label class="form-label">Repayment End Month</label>
                                            <input type="text" class="form-control" data-provide="datepicker" name = "endEnd" data-date-format="MM yyyy" data-date-min-view-mode="1" data-date-container="#datepicker5" onchange="validateEndDate()">
                                        </div>
...
<script type="text/javascript"> 
   ...
   function validateStartDate(){
        ...
        console.log(mnth)
        let x = document.forms["advanceForm"]["endStart"].value;
        let y = document.forms["advanceForm"]["endEnd"].value;
        if(x < mnth){
            alert('You can only select this month or greater');
            return false;
        }else{
            return true;
        }
