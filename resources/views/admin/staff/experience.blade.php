    ...
    <div class="row">
        ...
        <table class="table table-hover work_experience">
            ...
            <tbody>
                ...
                <?php $counter = 1; ?>
                @for ($i = 0; $i < sizeof(Session::get('workEducation')['institution_name']); $i++) <tr>
                    <td>{{$counter++}}</td>

                    <td>
                        <input type="text" name="institution_name[]" autocomplete="off" {{-- value="{{ Session::get('workEducation')['institution_name'][$i] ?? '' }}" --}} class="form-control" data-provide="datepicker" data-date-container="">
                    </td>
                    ...
                    <td>
                        <input autocomplete="off" {{-- value="{{ Session::get('workEducation')['position_held'][$i] ?? '' }}" --}} class="form-control underline" id="position_held" type="text" name="position_held[]">
                    </td>

                    <td>
                        <input autocomplete="off" {{-- value="{{ Session::get('workEducation')['job_functions'][$i] ?? '' }}" --}} class="form-control underline" name="job_functions[]" id="job_functions" type="text" id="">
                    </td>
                    ...
                    <tr>
                        ...
                        <td>
                            <input autocomplete="off" class="form-control underline" id="institution_name" type="text" name="institution_name[]">
                        </td>

                        <td>
                            <div class="mb-3 position-relative" id="work_start_year">
                                <input type="text" class="form-control" placeholder="YYYY only e.g 2004" name="work_start_year[]" id="work_start_year" data-provide="datepicker" data-date-container="#work_start_year">
                            </div>
                        </td>

                        <td>
                            <div class="mb-3 position-relative" id="work_end_year">
                                <input type="text" class="form-control" placeholder="YYYY only e.g 2004" name="work_end_year[]" id="work_end_year" autocomplete="off" data-provide="datepicker" data-date-container="#work_end_year">
                            </div>
                        </td>

                        <td>
                            <input autocomplete="off" value="" class="form-control underline" id="position_held" type="text" name="position_held[]">
                        </td>

                        <td>
                            <input autocomplete="off" class="form-control underline" name="job_functions[]" id="job_functions" value="" type="text">
                        </td>
    ...
    <div class="row">
        ...
        <table class="table table-hover education">
            ...
            <tbody>
                @if(Session::has('workEducation'))
                <?php $counter = 1; ?>
                @for ($i = 0; $i < sizeof(Session::get('workEducation')['education_type']); $i++) <tr>
                    <td>{{$counter++}}</td>
                    ...
                    <td>
                        ...
                        <select class="form-select" aria-label="Default select example" {{-- value="{{Session::get('workEducation')['qualification'][$i] ?? '' }}" --}} id="course" type="text" name="qualification[]">
                            ...
                            <option value="primary" @if (old('qualification')=='primary' ) selected="selected" @endif>PRIMARY</op tion>
                    ...
                    <td>
                        <!-- <input type="text" name="education_type[]" class="form-control" {{-- value="{{ Session::get('workEducation')['education_type'][$i] ?? '' }}" --}} /> -->
                        <select class="form-select" aria-label="Default select example" {{-- value="{{Session::get('workEducation')['qualification'][$i] ?? '' }}" --}} id="course" type="text" name="education_type[]">
                    ...
                    <td>
                    <select class="form-control" name="education_class_id[]" id="education_class_id">
                    ...
                    <td>
                        <input autocomplete="off" placeholder="Ignore if not applicable" class="form-control" {{-- value="{{ Session::get('workEducation')['institution_name'][$i] ?? '' }}" --}} id="institution_name" type="text" name="institution_name[]">
                    </td>

                    <td>
                        <input autocomplete="off" placeholder="Ignore if not applicable" class="form-control" {{-- value="{{ Session::get('workEducation')['course_name'][$i] ?? '' }}" --}} id="course" type="text" name="course_name[]">
                       
                    </td>

                    <!-- <td>
                        <input autocomplete="off" placeholder="Ignore if not applicable" class="form-control" {{-- value="{{Session::get('workEducation')['qualification'][$i] ?? '' }}" --}} id="course" type="text" name="qualification[]">
                    </td> -->
                    ...
                    <tr>
                        ...
                        <td>
                            <input autocomplete="off" placeholder="Ignore if not applicable" {{-- value="{!! old('institution_name') !!}" --}} class="form-control underline" id="institution_name" type="text" name="institution_name[]">
                        </td>

                        <td>
                            <input autocomplete="off" placeholder="Ignore if not applicable" {{-- value="{!! old('course_name') !!}" --}} class="form-control underline" id="course_name" type="text" name="course_name[]">
                        </td>
