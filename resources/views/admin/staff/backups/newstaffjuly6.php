                            ...
                            <div id="container" class="row form-group" style="margin-top: 20px">
                                <div class="col-md-3">
                                    <div id="staff-container">
                                        <img src="{{Session::has('personalInfo')?Session::get('personalInfo')['imgUrl'] : 'https://via.placeholder.com/200x200?text=Profile+Pictures'}}"
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-0">
                                            ...
                                            <input name="phone" required type="text"
                                                ...
                                                class="form-control" data-provide="phone" id="phone">
                                        </div>
                                    </div> <!-- end col -->
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 mt-3 mt-lg-0">
                                        ...
                                        <select id="maritalStatus"
                                            ...
                                            class="form-control select2" name="maritalStatus" data-toggle="select2">
                                            <option>Select</option>
