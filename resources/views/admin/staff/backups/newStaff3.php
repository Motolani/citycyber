                      ...
                      {{--dd(Session::get('personalInfo'))--}}
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name = "firstName" class="form-control" value="{{ Session::has('personalInfo')?Session::get('personalInfo')['firstName']:'dsds' }}" data-provide="typeahead" id="the-basics" placeholder="First Name" required>
                                </div>
                            </div> <!-- end col -->
                            ...
                            <div class="col-lg-4 mt-3 mt-lg-0">
                                <div class="mb-3">
                                    ...
                                    <input required id="lastName" name = "lastName" value = "{{ Session::get('personalInfo')['lastName'] }}" class="form-control" type="text" placeholder="Last Namr">
                                </div>
                            </div> <!-- end col -->
                        </div>
                        <!-- end row -->
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" value = ""  data-provide="typeahead" id="prefetch" name = "residentialAddress" placeholder="please enter Residential Address">
                                </div>
                            </div> <!-- end col -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="mb-0">
                                    ...
                                    <input name = "email" type="text" class="form-control" data-provide="typeahead" id="email" name = "email">
                                </div>
                            </div> <!-- end col -->
                        </div>
                        ...
                        <div class="row">
                            <div class="col-lg-6 mt-3 mt-lg-0">
                                ...
                                <select id = "yum" class="form-control select" name = "state" data-toggle="select">
                        ...
                        <div class="row">
                            <div class="col-lg-3">
                                <div class="mb-0">
                                    ...
                                    <input name = "nextofkinName" required type="text" class="form-control" data-provide="phone" id="nextofkinNamw">
                                </div>
                            </div> <!-- end col -->
                            ...
                            <div class="col-lg-3">
                                <div class="mb-0">
                                    ...
                                    <input name = "nextofkinRelationship" type="text" class="form-control" data-provide="typeahead" id="nextOfkinRelation">
                                </div>
                            </div> <!-- end col -->
                            ...
                            <div class="col-lg-3">
                                <div class="mb-0">
                                    ...
                                    <input name = "nextofkinPhone" type="text" class="form-control" data-provide="typeahead" id="multiple-ddatasets">
                                </div>
                            </div> <!-- end col -->
                            ...
                            <div class="col-lg-3">
                                <div class="mb-0">
                                    ...
                                    <input name = "nextofkinAddress" type="text" class="form-control" data-provide="typeahead" id="nextofkinAddress" >
                                </div>
                            </div> <!-- end col -->
                        </div>
                        <br/>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                <div class="mb-0">
                                    ...
                                    <input name = "emmergencyPhone" type="text" class="form-control" data-provide="typeahead" id="emmergencyPhone">
                                </div>
                            </div> <!-- end col -->
                            ...
                            <div class="col-lg-4">
                                <div class="mb-0">
                                    ...
                                    <input name = "emergencyAddress" type="text" class="form-control" data-provide="typeahead" id="emmergencyAddress">
                                </div>
                            </div> <!-- end col -->
