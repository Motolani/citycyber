...
--}}
		...
		<ul class="nav nav-tabs nav-bordered mb-3">
                    <li class="nav-item">
                        <a href="#typeahead-preview" data-bs-toggle="tab" aria-expanded="false" class="nav-link {{url()->current() == url('newStaff') ? 'active': 'complete'}}">
                            PERSONAL INFORMATION
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="#typeahead-preview" data-bs-toggle="tab" aria-expanded="false" class="nav-link {{url()->current() == url('createstaffConpanyInfo') ? 'active': 'complete'}}">
                            COMPANY INFORMATION
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="#typeahead-preview" data-bs-toggle="tab" aria-expanded="false" class="nav-link {{url()->current() == url('createWorkAndEduction') ? 'active': 'complete'}}">
                            EXPERIENCE
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="#typeahead-preview" data-bs-toggle="tab" aria-expanded="false" class="nav-link {{url()->current() == url('submitStaffForm') ? 'active': 'complete'}}">
                            SUMMARY
                        </a>
                    </li>
                </ul>
                            ...
                            <div class="row">
                                <div class="col-lg-4">
                                    <div class="mb-0">
                                        ...
                                        <input name="resumptionDate" data-provide="datepicker" data-date-container="#datepicker5"
                                ...
                                <div class="col-lg-4">
                                    <div class="mb-0">
                                        ...
                                        <input name="assumptionDate" type="text" data-provide="datepicker" data-date-container="#datepicker6"
                                ...
                                <div class="col-lg-4">
                                    <div class="mb-0">
                                        ...
                                        <input name="terminationDate" data-provide="datepicker" data-date-container="#datepicker7"
                                            value="{{ Session::has('companyInfo') ? Session::get('companyInfo')['assumptionDate'] : '' }}"
