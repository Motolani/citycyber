            ...
            <div class="card-body">
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane" id="staffDocument">
                        ...
                        @csrf
                            <input type="hidden" name="requireddocuments" value="{{json_encode($requiredDocuments['data'])}}" />
                            ...
                            <div class="row">
                                ...
                                @if($requiredDocuments['status'] == "300")
                                    @foreach($requiredDocuments['data'] as $documents)
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <label for="firstname" class="form-label">{{$documents}}</label>
                                                <input name="{{$documents}}" onchange="loadFile(event)" class="form-control form-control-sm" style="width: 300px;" id="formFileSm" type="file" />
                                            </div>
                                        </div>
                                    @endforeach
                                @else
                                    <span>{{$requiredDocuments['message']}}</span>
                                @endif
                            </div> <!-- end row -->
