...
<!--        <div class="row">
                    ...
                    <div class="card-body">
                        <center>
                            <form method="get" action="{{ route('viewCreateAdvanceGet')}}">
                                ...
                                <button class="btn btn-primary btn-sm" style="width: 100%;"><span class="uil-eye"></span>View/Create Salary Advance</button>
                            </form>
                        </center>
                    </div>
                </div>
            ...
            <div class="col-xl-4 col-lg-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        <center>
                            <form method="get" action="{{ route('cash-advance.viewCreate')}}">
                                @csrf
                                <input type="hidden" name="user_id" value="{{isset($staff->id)?$staff->id:''}}">

                                <button class="btn btn-primary btn-sm" style="width: 100%;"><span class="uil-eye"></span>View/Create Cash Advance</button>
                            </form>
                        </center>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        <center>
                            <form method="get" action="{{ route('viewCreateAllowanceGet')}}">
                                ...
                                <button class="btn btn-primary btn-sm" style="width: 100%;"><span class="uil-eye"></span>View/Create Allowance</button>
                            </form>
                        </center>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        <center>
                            <form method="get" action="{{route('staff.deduction.view')}}">
                                ...
                                <button class="btn btn-primary btn-sm" style="width: 100%;"><span class="uil-eye"></span>View/Create Deduction</button>
                            </form>
                        </center>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        <center>
                            <form method="get" action="{{ route('view.staff.loan')}}">
                                ...
                                <button class="btn btn-primary btn-sm" style="width: 100%;"><span class="uil-eye"></span>View/Create Loan</button>
                            </form>
                        </center>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        <center>
                            <form method="get" action="{{ route('staff.damages')}}">
                                ...
                                <button class="btn btn-primary btn-sm" style="width: 100%;"><span class="uil-eye"></span>View/Create Loss/Damages</button>
                            </form>
                        </center>
                    </div>
                </div>
        ...
        <div class="row">
                    ...
                    <div class="card-body">
                        <center>
                            <form method="get" action="{{route('viewLeaveRequest')}}">
                                ...
                                <button class="btn btn-primary btn-sm" style="width: 100%;"><span class="uil-eye"></span>View/Request Leave Request</button>
                            </form>
                        </center>
                    </div>
                </div>
            ...
            <div class="col-xl-4 col-lg-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        <center>
                            <form method="get" action="{{ route("myRequests")}}">
                                @csrf
                                <input type="hidden" name="user_id" value="{{isset($staff->id)?$staff->id:''}}">

                                <button class="btn btn-primary btn-sm" style="width: 100%;"><span class="uil-eye"></span>View/Requesst Petty Cash</button>
                            </form>
                        </center>
                    </div>
                </div>
