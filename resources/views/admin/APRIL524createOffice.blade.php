        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="tab-content">
                    <div class="tab-pane show active" id="typeahead-preview">
                        <form action="{{route('createOffice')}}" method="POST">
                            @csrf
                            <div class="row">
                                <div class="col-lg-6 mt-3 mt-lg-0">
                                    <p class="mb-1 fw-bold text-muted"></p>
                                ...
                                <div class="col-lg-6 mt-3">
                                    ...
                                    <input type="text" class="form-control" name="type" data-provide="typeahead" value="" readonly id="officeType" placeholder="">
                                </div> <!-- end col -->

                                <div class="col-lg-6">
                                    <div class="mb-3 mt-3">
                                        <label class="form-label">Name</label>
                                        <input type="text" name="name" class="form-control" data-provide="typeahead" id="the-basics" placeholder="name" value="{{old('name')}}">
                                    </div>
                                </div> <!-- end col -->
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="mb-3 ">
                                                ...
                                                <input type="text" class="form-control" name="region_acronym" value="{{old('region_acronym')}}" id="" placeholder="enter region acronym">
                                            </div>
                                        </div> <!-- end col -->
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" name="area_acronym" value="{{old('area_acronym')}}" id="" placeholder="enter area acronym">
                                            </div>
                                        </div> <!-- end col -->
                                    </div>
                                ...
                                <div class="col-lg-6 mt-3 mt-lg-0">
                                    <div class="mb-3">
                                        ...
                                        <input id="bloodhound" name="emailAddress" class="form-control" type="text" placeholder="email" value="{{old('emailAddress')}}">
                                    </div>
                                </div> <!-- end col -->
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control" data-provide="typeahead" id="prefetch" name="phone" placeholder="phone" value="{{old('phone')}}">
                                    </div>
                                </div> <!-- end col -->
                                <div class="col-lg-12">
                                    <div class="mb-3">
                                ...
                                <div class="col-lg-12 mt-3 mt-lg-0">
                                    <div class="mb-3">
                                        ...
                                        <input name="location" type="text" class="form-control" data-provide="typeahead" id="remote" placeholder="10 John str, Ipaja" value="{{old('location ')}}">
                                    </div>
                                </div> <!-- end col -->
                                ...
                                <div class="col-lg-4">
                                    ...
                                    <select id="state" class="form-control select select2" name="state" data-toggle="select">
					...
					<label class="form-label">City Name</label>
                                        <input type="text" name="lga" class="form-control @error('lga') is-invalid @enderror" placeholder="enter city name ">
                                        <!--<input name="lga" type="text" class="form-control"  placeholder="10 John str, Ipaja" value="{{old('location ')}}">-->
                                        <!-- </select> -->
                                ...
                                <div class="branch-office " style="display: none;">
                                    <div class="row g-3">
                                        <div class="col-md-6 py-2">
                                            ...
                                            <input type="text" name="bet_code" class="form-control @error('bet_code') is-invalid @enderror" placeholder="bet9ja code">
                                        </div>
                                        @error('bet_code')
                                        ...
                                        <div class="col-md-6 py-2">
                                            ...
                                            <input type="text" name="bet_id" class="form-control @error('bet_id') is-invalid @enderror" placeholder="bet9ja id">
                                        </div>
                                        @error('bet_id')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    ...
                                    <div class="row g-3">
                                        <div class="col-md-12" py-2>
                                            ...
                                            <select name="branch_report" id="branch_report" class="form-control select2 @error('branch_report') is-invalid @enderror" data-toggle="select2">
                                                <option>Select</option>
                                            </select>
                                            @error('branch_report')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                    ...
                                    <div class="row g-3">
                                        <div class="col-md-6 py-2">
                                            ...
                                            <input type="text" name="land_name" class="form-control @error('land_name') is-invalid @enderror" placeholder="landlord name ">
                                        </div>
                                        @error('land_lord')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    ...
                                    <div class="row g-3">
                                        <div class="col-md-6 py-2">
                                            ...
                                            <input type="email" name="land_email" class="form-control @error('land_email') is-invalid @enderror" placeholder="landlord email">
                                        </div>
                                        @error('land_email')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                        <div class="col-md-6 py-2">
                                            ...
                                            <input type="text" name="care_name" class="form-control @error('care_name') is-invalid @enderror" placeholder="caretaker name">
                                        </div>
                                        @error('care_name')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    ...
                                    <div class="row g-3">
                                        <div class="col-md-6 py-2">
                                            ...
                                            <input type="number" name="care_phone" class="form-control @error('care_phone') is-invalid @enderror" placeholder="caretaker phone">
                                        </div>
                                        @error('care_phone')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                        <div class="col-md-6 py-2">
                                            ...
                                            <input type="email" name="care_email" class="form-control @error('care_email') is-invalid @enderror" placeholder="caretaker email">
                                        </div>
                                        @error('care_email')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
