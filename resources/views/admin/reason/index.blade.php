            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item active" style="display:none" id="headerShow">View/Edit Stock Categories</li>
                    </ol>
                </div>
        ...
        <div class="col-md-4">
            <div class="card">
                <div class="card-body">
                    ...
                    <h4 class="header-title">Add Reason</h4>
                    <form method = "POST" action = "{{route('reason.createNewReason')}}">
                        @csrf
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="mb-3 mt-4">
                                    <label class="form-label">Reason</label>
                                    <input type="text" name="name" class="form-control" placeholder="Reason" required>
                                </div>
                            </div>
                            <!-- end col -->
        ...
        <div class="col-8">
            <div class="card">
                <div class="card-body">
                    ...
                    <h4 class="header-title">List of all Reason</h4>
                                ...
                                @if(isset($items))
                                    @foreach($items as $item)
                                        <tr>
                                            <td>{{$item->name}}</td>
                                            <td>
                                                <a href="{{route('reason.delete',$item->id)}}" class="btn btn-danger btn-sm">
