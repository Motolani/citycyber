    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                ...
                <h4 class="page-title">Stock Categories</h4>
            </div>
        </div>
    </div>
    <!-- end page title -->
        ...
        <div class="col-md-4">
            <div class="card">
                <div class="card-body">
                    ...
                    <form method = "POST" action = "{{route('stock-category.create')}}">
                        @csrf
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="mb-3 mt-4">
                                    <label class="form-label">Category Name</label>
                                    <input type="text" name="name" class="form-control" placeholder="Phones" required>
                                </div>
