                            ...
                            <div class="row justify-content-center">
                                <div class="col-lg-8">
                                    <form action = "{{route('assignProduct.ToOffice')}}" method = "GET">
                                        ...
                                        <div class="mb-3">
                                            <label for="example-date" class="form-label required">Select Product</label>
                                        ...
                                        <div class="mb-3">
                                            <label class="form-label required">Payment Period (In Weeks)</label>
                                            <input type="number" name="payment_period" class="form-control" placeholder="3" required>
                                        </div>
