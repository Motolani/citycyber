    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                ...
                <a href="{{url('/viewStructural-standard-requirement')}}" class="btn btn-primary mb-2" >Go Back</a>
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item active" style = "display:none" id = "headerShow">Manger Structural & Standard Requirement</li>
                    </ol>
                </div>
                <h4 class="page-title">Manger Structural & Standard Requirement</h4>
            </div>
        </div>
    </div>
    <!-- end page title -->
    ...
    <div class="col-9">
        <div class="card">
            <div class="card-body">
                ...
                <!-- <h4 class="header-title" style = "">Create Structural & Standard Requirement</h4> -->
                ...
                <div class="tab-content">
                    <div class="tab-pane show active" id="input-types-preview">
                        <div class="row justify-content-center">
                            <div class="col-lg-9">
                                <form action = "{{route('storeStructuralstandard')}}" method = "POST"> 
                                
                                    @csrf
                                    
                                    <h3>Create Structural & Standard Requirement</h3>
                                    <br>
                                    <br>
                                    <div class="row">
                                         <div class="col-lg-9">
                                            <div class="mb-3">
                                                <label class="form-label">Structural and Standard Requirement</label>
                                                <input name="structuralstandardrequirement" type="text" required type="text"  class="form-control">
                                            </div>
                                        </div>  
                                </div>
