    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                ...
                <h4 class="page-title">Petty Cash Categories</h4>
            </div>
        </div>
    </div>
    <!-- end page title -->
        ...
        <div class="col-md-4">
            <div class="card">
                <div class="card-body">
                    ...
                    <form method = "POST" action = "{{route('pettycash.doAddCategory')}}">
                        @csrf
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="mb-3 mt-4">
                                ...
                                @if(isset($categories))
                                    @foreach($categories as $category)
                                        <tr>
                                            <td>{{$category->name}}</td>
                                            <td>
                                                <a href="{{route('pettycash.doDeleteCategory',$category->id)}}" class="btn btn-danger btn-sm">
