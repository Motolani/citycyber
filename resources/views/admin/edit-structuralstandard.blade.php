            ...
            <div class="page-title-box">
                ...
                <a href="{{url('/createStructural-standard-requirement')}}" class="btn btn-primary mb-2" >Go Back</a>
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item active" style = "display:none" id = "headerShow">Create Structural & Standard Requirement</li>
                    </ol>
                </div>
                <h4 class="page-title">Create Structural & Standard Requirement</h4>
            </div>
        </div>
    </div>
    <!-- end page title -->
            ...
            <div class="card-body">
                ...
                <div class="tab-content">
                    <div class="tab-pane show active" id="input-types-preview">
                        <div class="row justify-content-center">
                            <div class="col-lg-9">
                                <form action = "{{route('updateStructuralstandard',$structuralstandard->id)}}" method = "POST"> 
                                    ...
                                    <div class="row">
                                         <div class="col-lg-9">
                                            <div class="mb-3">
                                                ...
                                                <input name="structuralstandardrequirement" type="text" value="{{$structuralstandard->structuralstandardrequirement}}" class="form-control">
                                            </div>
                                        </div>  
                                </div>
