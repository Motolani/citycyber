            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active" style = "display:none" id = "headerShow">View Bills</li>
                    </ol>
                </div>
                <h4 class="page-title">View Bills</h4>
            </div>
        </div>
    </div>
    <!-- end page title -->
                                ...
                                <tbody>
                                    @if(isset($bills))
                                        @foreach($bills as $user)
                                            <tr>
                                                <td>
                                                    <a href="{{route('editBill',$user->id)}}" class="btn btn-primary btn-sm phils" ><span class="uil-edit"></span></a>

                                                    <form method="post" action="{{route('deleteBill',$user->id)}}">
                                                        @csrf
                                                        @method('delete') 
