    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                ...
                <h4 class="page-title ">Create Game Commission</h4>
            </div>
        </div>
    </div>
    <!-- end page title -->
            ...
            <div class="card">
                <div class="card-body" >
                    ...
                    <p class="text-muted font-14">
                        Here you can create game commission 
                    </p>

                    <div class="tab-content">
                        <div class="tab-pane show active" id="typeahead-preview">
                            <form method = "POST" action = "{{url('store-game-commission')}}">
                                @csrf
                                  <div class="row">
...
{{--                                     
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <div class=" row border p-2">
                                               ...
                                               <div class="col-md-6 mb-3 mb-3">
                                                ...
                                                <input type="text"  name="date_range_from" id="fromdate" value="{{old('date')}}" class="form-control" placeholder="please select date">
                                            </div>
                                            <div class="col-md-6 mb-3 mb-3">
                                                <label for="card number">Date Range To</label>
                                                <input type="text"  name="date_range_to"  id="topdate" value="{{old('date')}}" class="form-control" placeholder="please select game date">
                                            </div>
                                    ...
                                    <div class="col-md-4 offset-md-8">
                                        ...
                                        <button type="submit" class="btn btn-primary">Create Game Commission</button>
                                    </div>
                                  </div>
                            </form>
                        </div> <!-- end preview-->
