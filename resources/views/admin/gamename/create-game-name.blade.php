...
@section('content')
    ...
    <!-- end page title -->
        ...
        <div class="col-8 offset-2" id = "h_div" style = "align-content:center, float:right">
            <div class="card">
                <div class="card-body" >
                    <h4 class="header-title" style = "">Create Name
                    </h4>
                    ...
                    <p class="text-muted font-14">
                        Here you can create game name 
                    </p>

                    <div class="tab-content">
                        <div class="tab-pane show active" id="typeahead-preview">
                            <form method = "POST" action = "{{url('store-game-name')}}">
                                @csrf
                                {{-- @method('PUT') --}}
                                <div class="row ">
                                    <div class="col-md-8  mb-3">
                                    <label for="cable type">Game Name</label>
                                        <input type="text"  name="name" class="form-control" placeholder="please enter the game name" autocomplete="off">
                                    </div>                       
                                    </div> 
                                    ...
                                    <div class="col-md-12 ">
                                        ...
                                        <button type="submit" class="btn btn-primary">Create Game Name</button>
                                    </div>
                                  </div>
                            </form>
                        </div> <!-- end preview-->
