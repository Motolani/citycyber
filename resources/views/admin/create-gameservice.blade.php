            ...
            <div class="page-title-box">
                ...
                <a href="{{url('/create-gameservice')}}" class="btn btn-primary mb-2" >Go Back</a> 
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item active" style = "display:none" id = "headerShow">Game Service</li>
                    </ol>
                </div>
                <h4 class="page-title">Game Service</h4>
            </div>
        </div>
    </div>
    <!-- end page title -->
            ...
            <div class="card-body">
                ...
                <div class="tab-content">
                    <div class="tab-pane show active" id="input-types-preview">
                        <div class="row justify-content-center">
                            <div class="col-lg-9">
                                <form action = "{{route('storeGameservice')}}" method = "POST"> 
                                
                                
                                    @csrf
                                    
                                    <h3>Create Game Service</h3>
                                    <br>
                                    <br>
                                    <div class="row">
                                         <div class="col-lg-9">
                                            <div class="mb-3">
                                                ...
                                                <input name="game_name" type="text" value="{{old('game_name')}}" required  class="form-control">
                                            </div>
                                        </div>  
                                    </div>
