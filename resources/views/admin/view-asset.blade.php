...
@section('content')
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                ...
                <a href="{{url('/create-asset')}}" class="btn btn-primary mb-2" >Go Back</a>
                    <ol class="breadcrumb m-0">

                        <li class="breadcrumb-item active" style = "display:none" id = "headerShow">View/Edit Asset</li>
                    </ol>
                </div>
                <h4 class="page-title">View/Edit Asset</h4>
            </div>
        </div>
    </div>
    <!-- end page title -->
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <a href="{{url('/create-asset')}}" class="btn btn-primary mb-2" >Add Asset </a>
                    ...
                    <div class="tab-content">
                        <div class="tab-pane show active" id="buttons-table-preview">
                                    ...
                                    @foreach($asset as $data)
                                        <tr>
                                            ...
                                            <td>{{$data->type}}</td>
                                                ...
                                                <td>
                                                    <a href="{{route('editAsset',$data->id)}}" class="btn btn-success"><span class="uil-eye mb-1">Edit</a>
                                                </td>
                            ...
                            <form action="{{URL::to('delete-asset/')}}" name="delete" method="post">
                                                    @csrf
                                                    {{-- @method('DELETE') --}}
...
<script>
    ...
    {
    console.log(type)      
    document.getElementById('modalType').innerText = "You about to Delete asset with type: " + type
