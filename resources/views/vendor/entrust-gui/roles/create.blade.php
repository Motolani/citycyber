...
<button type="submit" class="btn btn-labeled btn-primary mt-3"><span class="btn-label">
        <i class="fa fa-plus"></i></span>{{ trans('entrust-gui::button.create') }}
</button>

<button class="btn btn-labeled btn-default mt-3" href="{{ route('entrust-gui::roles.index') }}">
